...
module.exports = {
    isSupported,
    getLoadError,
    configure(channelId, productName, productVersion, keychainStorageEnabled) {
        return requireBinding().configure(channelId, productName, productVersion, keychainStorageEnabled);
    },
